    ...
    <Box>
      <Paper
        ...
        sx={{
          ...
          background:
            theme.palette.mode === 'dark' ? 'rgba(50,50,50,0.9)' : 'rgba(248,249,250,0.95)',
          borderBottom: 'none',
      ...
      >
        <Box sx={{ display: 'flex', gap: 2, flexWrap: 'wrap' }}>
          <ButtonGroup
            variant="outlined"
            sx={{ '& .MuiIconButton-root': { minWidth: '40px', height: '40px' } }}
          >
            <Tooltip title="Heading 1" arrow>
              <IconButton onClick={addHeading1} onMouseDown={handleMouseDown}>
                <Typography variant="body2" sx={{ fontWeight: 'semibold', fontSize: '16px' }}>
                  H1
                </Typography>
              </IconButton>
            </Tooltip>
      ...
      <Paper
        ...
        sx={{
          ...
          background:
            theme.palette.mode === 'dark' ? 'rgba(30,30,30,0.6)' : 'rgba(255,255,255,0.95)',
          backdropFilter: 'blur(10px)',
